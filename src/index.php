...
if (isset($_GET['id_comentario']) && isset($_GET["confirmar-borrar"]) && $_SESSION['rol'] != "Visitante" ) {
    $id_comentario = $_GET["id_comentario"];
    borrar_comentario($conexion, $id_comentario);
}
...
if(isset($_POST['enviar-comentario']) && isset($_GET['id_incidencia'])){
    ...
    if(empty($comentario["error"])){
        ...
        if(isset($_SESSION['usuario'])){
            ...
            insertar_comentario($conexion, "Anónimo", $id_incidencia, $comentario["texto"]);
        }
    }
}
...
$_SESSION['total_incidencias'] = count($incidencias);
...
HTML_mostrar_incidencia($incidencias,$conexion, $lugares);
